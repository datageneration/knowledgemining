# R Class demo (Model selection: Subset selection, forward stepwise, backward stepwise)
...
par(mfrow=c(2,2))
# type="l" option to connect the plotted points with lines.
...
summary(regfit.bwd)
coef(regfit.full,7) #best seven-variable full model
coef(regfit.fwd,7)  #best seven-variable forward stepwise model
coef(regfit.bwd,7)  #best seven-variable backward stepwise model
